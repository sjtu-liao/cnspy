...
#include "lorenz63_higher.h"
#define _prec 1661
#define _order 800
int main(int argc, char *argv[]){
	tsm_init();
	tsm_clock_start();
	FILE *fp=fopen("..\ans\result_lorenz63_higher.txt","w");
	int i, j, order;
	order = _order;
	...
	mpfr_set_str(constant_0, "-2.", 10, GMP_RNDN);
	mpfr_set_str(constant_1, "10.", 10, GMP_RNDN);
	mpfr_set_str(constant_2, "-10.", 10, GMP_RNDN);
	mpfr_set_str(constant_3, "28.", 10, GMP_RNDN);
	mpfr_set_str(constant_4, "-1.", 10, GMP_RNDN);
